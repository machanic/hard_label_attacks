...
def get_file_name_list(dataset, method_name_to_paper, norm, targeted):
    ...
    for method, paper_method_name in method_name_to_paper.items():
        file_path = "F:/logs/hard_label_attacks/" + from_method_to_dir_path(dataset, method, norm, targeted)
...
def draw_tables_for_multi_priors(result, surrogate_1, surrogate_2, surrogate_3, surrogate_4, surrogate_5):
    print("""
        ...
        PriorSignOPT_prior1_1000_victim_model_1=result["resnet101"]["Prior-Sign-OPT-prior1"][1000],
        PriorSignOPT_prior1_2000_victim_model_1=result["resnet101"]["Prior-Sign-OPT-prior1"][2000],
        PriorSignOPT_prior1_5000_victim_model_1=result["resnet101"]["Prior-Sign-OPT-prior1"][5000],
        PriorSignOPT_prior1_8000_victim_model_1=result["resnet101"]["Prior-Sign-OPT-prior1"][8000],
        PriorSignOPT_prior1_10000_victim_model_1=result["resnet101"]["Prior-Sign-OPT-prior1"][10000],

        PriorSignOPT_2priors_1000_victim_model_1=result["resnet101"]["Prior-Sign-OPT-2priors"][1000],
        PriorSignOPT_2priors_2000_victim_model_1=result["resnet101"]["Prior-Sign-OPT-2priors"][2000],
        PriorSignOPT_2priors_5000_victim_model_1=result["resnet101"]["Prior-Sign-OPT-2priors"][5000],
        PriorSignOPT_2priors_8000_victim_model_1=result["resnet101"]["Prior-Sign-OPT-2priors"][8000],
        PriorSignOPT_2priors_10000_victim_model_1=result["resnet101"]["Prior-Sign-OPT-2priors"][10000],
        ...
        PriorOPT_prior1_1000_victim_model_1=result["resnet101"]["Prior-OPT-prior1"][1000],
        PriorOPT_prior1_2000_victim_model_1=result["resnet101"]["Prior-OPT-prior1"][2000],
        PriorOPT_prior1_5000_victim_model_1=result["resnet101"]["Prior-OPT-prior1"][5000],
        PriorOPT_prior1_8000_victim_model_1=result["resnet101"]["Prior-OPT-prior1"][8000],
        PriorOPT_prior1_10000_victim_model_1=result["resnet101"]["Prior-OPT-prior1"][10000],

        PriorOPT_2priors_1000_victim_model_1=result["resnet101"]["Prior-OPT-2priors"][1000],
        PriorOPT_2priors_2000_victim_model_1=result["resnet101"]["Prior-OPT-2priors"][2000],
        PriorOPT_2priors_5000_victim_model_1=result["resnet101"]["Prior-OPT-2priors"][5000],
        PriorOPT_2priors_8000_victim_model_1=result["resnet101"]["Prior-OPT-2priors"][8000],
        PriorOPT_2priors_10000_victim_model_1=result["resnet101"]["Prior-OPT-2priors"][10000],
        ...
        PriorSignOPT_prior1_1000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-Sign-OPT-prior1"][1000],
        PriorSignOPT_prior1_2000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-Sign-OPT-prior1"][2000],
        PriorSignOPT_prior1_5000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-Sign-OPT-prior1"][5000],
        PriorSignOPT_prior1_8000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-Sign-OPT-prior1"][8000],
        PriorSignOPT_prior1_10000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-Sign-OPT-prior1"][10000],

        PriorSignOPT_2priors_1000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-Sign-OPT-2priors"][1000],
        PriorSignOPT_2priors_2000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-Sign-OPT-2priors"][2000],
        PriorSignOPT_2priors_5000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-Sign-OPT-2priors"][5000],
        PriorSignOPT_2priors_8000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-Sign-OPT-2priors"][8000],
        PriorSignOPT_2priors_10000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-Sign-OPT-2priors"][10000],
        ...
        PriorOPT_prior1_1000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-OPT-prior1"][1000],
        PriorOPT_prior1_2000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-OPT-prior1"][2000],
        PriorOPT_prior1_5000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-OPT-prior1"][5000],
        PriorOPT_prior1_8000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-OPT-prior1"][8000],
        PriorOPT_prior1_10000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-OPT-prior1"][10000],

        PriorOPT_2priors_1000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-OPT-2priors"][1000],
        PriorOPT_2priors_2000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-OPT-2priors"][2000],
        PriorOPT_2priors_5000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-OPT-2priors"][5000],
        PriorOPT_2priors_8000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-OPT-2priors"][8000],
        PriorOPT_2priors_10000_victim_model_2=result["swin_base_patch4_window7_224"]["Prior-OPT-2priors"][10000],
        ...
        PriorSignOPT_prior1_1000_victim_model_3=result["gcvit_base"]["Prior-Sign-OPT-prior1"][1000],
        PriorSignOPT_prior1_2000_victim_model_3=result["gcvit_base"]["Prior-Sign-OPT-prior1"][2000],
        PriorSignOPT_prior1_5000_victim_model_3=result["gcvit_base"]["Prior-Sign-OPT-prior1"][5000],
        PriorSignOPT_prior1_8000_victim_model_3=result["gcvit_base"]["Prior-Sign-OPT-prior1"][8000],
        PriorSignOPT_prior1_10000_victim_model_3=result["gcvit_base"]["Prior-Sign-OPT-prior1"][10000],

        PriorSignOPT_2priors_1000_victim_model_3=result["gcvit_base"]["Prior-Sign-OPT-2priors"][1000],
        PriorSignOPT_2priors_2000_victim_model_3=result["gcvit_base"]["Prior-Sign-OPT-2priors"][2000],
        PriorSignOPT_2priors_5000_victim_model_3=result["gcvit_base"]["Prior-Sign-OPT-2priors"][5000],
        PriorSignOPT_2priors_8000_victim_model_3=result["gcvit_base"]["Prior-Sign-OPT-2priors"][8000],
        PriorSignOPT_2priors_10000_victim_model_3=result["gcvit_base"]["Prior-Sign-OPT-2priors"][10000],
        ...
        PriorOPT_prior1_1000_victim_model_3=result["gcvit_base"]["Prior-OPT-prior1"][1000],
        PriorOPT_prior1_2000_victim_model_3=result["gcvit_base"]["Prior-OPT-prior1"][2000],
        PriorOPT_prior1_5000_victim_model_3=result["gcvit_base"]["Prior-OPT-prior1"][5000],
        PriorOPT_prior1_8000_victim_model_3=result["gcvit_base"]["Prior-OPT-prior1"][8000],
        PriorOPT_prior1_10000_victim_model_3=result["gcvit_base"]["Prior-OPT-prior1"][10000],

        PriorOPT_2priors_1000_victim_model_3=result["gcvit_base"]["Prior-OPT-2priors"][1000],
        PriorOPT_2priors_2000_victim_model_3=result["gcvit_base"]["Prior-OPT-2priors"][2000],
        PriorOPT_2priors_5000_victim_model_3=result["gcvit_base"]["Prior-OPT-2priors"][5000],
        PriorOPT_2priors_8000_victim_model_3=result["gcvit_base"]["Prior-OPT-2priors"][8000],
        PriorOPT_2priors_10000_victim_model_3=result["gcvit_base"]["Prior-OPT-2priors"][10000],
...
if __name__ == "__main__":
    ...
    result = fetch_all_json_content_given_contraint(dataset, norm, False, arch, query_budgets, wanted_one_prior1_list, wanted_one_prior2_list,
                                                    wanted_two_priors_list, "median_distortion")
