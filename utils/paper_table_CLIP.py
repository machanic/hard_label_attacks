...
def draw_tables_for_multi_priors(result, surrogate_1, surrogate_2, surrogate_3, surrogate_4, surrogate_5):
    print("""
        ...
        SignOPT_1000_victim_model_1=result["distortion"]["Sign-OPT"][1000],
        SignOPT_2000_victim_model_1=result["distortion"]["Sign-OPT"][2000],
        SignOPT_5000_victim_model_1=result["distortion"]["Sign-OPT"][5000],
        SignOPT_8000_victim_model_1=result["distortion"]["Sign-OPT"][8000],
        SignOPT_10000_victim_model_1=result["distortion"]["Sign-OPT"][10000],


        PriorSignOPT_prior1_1000_victim_model_1=result["distortion"]["Prior-Sign-OPT-1prior"][1000],
        PriorSignOPT_prior1_2000_victim_model_1=result["distortion"]["Prior-Sign-OPT-1prior"][2000],
        PriorSignOPT_prior1_5000_victim_model_1=result["distortion"]["Prior-Sign-OPT-1prior"][5000],
        PriorSignOPT_prior1_8000_victim_model_1=result["distortion"]["Prior-Sign-OPT-1prior"][8000],
        PriorSignOPT_prior1_10000_victim_model_1=result["distortion"]["Prior-Sign-OPT-1prior"][10000],

        PriorSignOPT_2priors_1000_victim_model_1=result["distortion"]["Prior-Sign-OPT-2prior"][1000],
        PriorSignOPT_2priors_2000_victim_model_1=result["distortion"]["Prior-Sign-OPT-2prior"][2000],
        PriorSignOPT_2priors_5000_victim_model_1=result["distortion"]["Prior-Sign-OPT-2prior"][5000],
        PriorSignOPT_2priors_8000_victim_model_1=result["distortion"]["Prior-Sign-OPT-2prior"][8000],
        PriorSignOPT_2priors_10000_victim_model_1=result["distortion"]["Prior-Sign-OPT-2prior"][10000],

        PriorSignOPT_3prior_1000_victim_model_1=result["distortion"]["Prior-Sign-OPT-3prior"][1000],
        PriorSignOPT_3prior_2000_victim_model_1=result["distortion"]["Prior-Sign-OPT-3prior"][2000],
        PriorSignOPT_3prior_5000_victim_model_1=result["distortion"]["Prior-Sign-OPT-3prior"][5000],
        PriorSignOPT_3prior_8000_victim_model_1=result["distortion"]["Prior-Sign-OPT-3prior"][8000],
        PriorSignOPT_3prior_10000_victim_model_1=result["distortion"]["Prior-Sign-OPT-3prior"][10000],

        PriorSignOPT_4prior_1000_victim_model_1=result["distortion"]["Prior-Sign-OPT-4prior"][1000],
        PriorSignOPT_4prior_2000_victim_model_1=result["distortion"]["Prior-Sign-OPT-4prior"][2000],
        PriorSignOPT_4prior_5000_victim_model_1=result["distortion"]["Prior-Sign-OPT-4prior"][5000],
        PriorSignOPT_4prior_8000_victim_model_1=result["distortion"]["Prior-Sign-OPT-4prior"][8000],
        PriorSignOPT_4prior_10000_victim_model_1=result["distortion"]["Prior-Sign-OPT-4prior"][10000],

        PriorSignOPT_5prior_1000_victim_model_1=result["distortion"]["Prior-Sign-OPT-5prior"][1000],
        PriorSignOPT_5prior_2000_victim_model_1=result["distortion"]["Prior-Sign-OPT-5prior"][2000],
        PriorSignOPT_5prior_5000_victim_model_1=result["distortion"]["Prior-Sign-OPT-5prior"][5000],
        PriorSignOPT_5prior_8000_victim_model_1=result["distortion"]["Prior-Sign-OPT-5prior"][8000],
        PriorSignOPT_5prior_10000_victim_model_1=result["distortion"]["Prior-Sign-OPT-5prior"][10000],

        PriorOPT_prior1_1000_victim_model_1=result["distortion"]["Prior-OPT-1prior"][1000],
        PriorOPT_prior1_2000_victim_model_1=result["distortion"]["Prior-OPT-1prior"][2000],
        PriorOPT_prior1_5000_victim_model_1=result["distortion"]["Prior-OPT-1prior"][5000],
        PriorOPT_prior1_8000_victim_model_1=result["distortion"]["Prior-OPT-1prior"][8000],
        PriorOPT_prior1_10000_victim_model_1=result["distortion"]["Prior-OPT-1prior"][10000],

        PriorOPT_2priors_1000_victim_model_1=result["distortion"]["Prior-OPT-2prior"][1000],
        PriorOPT_2priors_2000_victim_model_1=result["distortion"]["Prior-OPT-2prior"][2000],
        PriorOPT_2priors_5000_victim_model_1=result["distortion"]["Prior-OPT-2prior"][5000],
        PriorOPT_2priors_8000_victim_model_1=result["distortion"]["Prior-OPT-2prior"][8000],
        PriorOPT_2priors_10000_victim_model_1=result["distortion"]["Prior-OPT-2prior"][10000],

        PriorOPT_3prior_1000_victim_model_1=result["distortion"]["Prior-OPT-3prior"][1000],
        PriorOPT_3prior_2000_victim_model_1=result["distortion"]["Prior-OPT-3prior"][2000],
        PriorOPT_3prior_5000_victim_model_1=result["distortion"]["Prior-OPT-3prior"][5000],
        PriorOPT_3prior_8000_victim_model_1=result["distortion"]["Prior-OPT-3prior"][8000],
        PriorOPT_3prior_10000_victim_model_1=result["distortion"]["Prior-OPT-3prior"][10000],

        PriorOPT_4prior_1000_victim_model_1=result["distortion"]["Prior-OPT-4prior"][1000],
        PriorOPT_4prior_2000_victim_model_1=result["distortion"]["Prior-OPT-4prior"][2000],
        PriorOPT_4prior_5000_victim_model_1=result["distortion"]["Prior-OPT-4prior"][5000],
        PriorOPT_4prior_8000_victim_model_1=result["distortion"]["Prior-OPT-4prior"][8000],
        PriorOPT_4prior_10000_victim_model_1=result["distortion"]["Prior-OPT-4prior"][10000],

        PriorOPT_5prior_1000_victim_model_1=result["distortion"]["Prior-OPT-5prior"][1000],
        PriorOPT_5prior_2000_victim_model_1=result["distortion"]["Prior-OPT-5prior"][2000],
        PriorOPT_5prior_5000_victim_model_1=result["distortion"]["Prior-OPT-5prior"][5000],
        PriorOPT_5prior_8000_victim_model_1=result["distortion"]["Prior-OPT-5prior"][8000],
        PriorOPT_5prior_10000_victim_model_1=result["distortion"]["Prior-OPT-5prior"][10000],


        SignOPT_1000_victim_model_2=result["ASR"]["Sign-OPT"][1000],
        SignOPT_2000_victim_model_2=result["ASR"]["Sign-OPT"][2000],
        SignOPT_5000_victim_model_2=result["ASR"]["Sign-OPT"][5000],
        SignOPT_8000_victim_model_2=result["ASR"]["Sign-OPT"][8000],
        SignOPT_10000_victim_model_2=result["ASR"]["Sign-OPT"][10000],


        PriorSignOPT_prior1_1000_victim_model_2=result["ASR"]["Prior-Sign-OPT-1prior"][1000],
        PriorSignOPT_prior1_2000_victim_model_2=result["ASR"]["Prior-Sign-OPT-1prior"][2000],
        PriorSignOPT_prior1_5000_victim_model_2=result["ASR"]["Prior-Sign-OPT-1prior"][5000],
        PriorSignOPT_prior1_8000_victim_model_2=result["ASR"]["Prior-Sign-OPT-1prior"][8000],
        PriorSignOPT_prior1_10000_victim_model_2=result["ASR"]["Prior-Sign-OPT-1prior"][10000],

        PriorSignOPT_2priors_1000_victim_model_2=result["ASR"]["Prior-Sign-OPT-2prior"][1000],
        PriorSignOPT_2priors_2000_victim_model_2=result["ASR"]["Prior-Sign-OPT-2prior"][2000],
        PriorSignOPT_2priors_5000_victim_model_2=result["ASR"]["Prior-Sign-OPT-2prior"][5000],
        PriorSignOPT_2priors_8000_victim_model_2=result["ASR"]["Prior-Sign-OPT-2prior"][8000],
        PriorSignOPT_2priors_10000_victim_model_2=result["ASR"]["Prior-Sign-OPT-2prior"][10000],

        PriorSignOPT_3prior_1000_victim_model_2=result["ASR"]["Prior-Sign-OPT-3prior"][1000],
        PriorSignOPT_3prior_2000_victim_model_2=result["ASR"]["Prior-Sign-OPT-3prior"][2000],
        PriorSignOPT_3prior_5000_victim_model_2=result["ASR"]["Prior-Sign-OPT-3prior"][5000],
        PriorSignOPT_3prior_8000_victim_model_2=result["ASR"]["Prior-Sign-OPT-3prior"][8000],
        PriorSignOPT_3prior_10000_victim_model_2=result["ASR"]["Prior-Sign-OPT-3prior"][10000],

        PriorSignOPT_4prior_1000_victim_model_2=result["ASR"]["Prior-Sign-OPT-4prior"][1000],
        PriorSignOPT_4prior_2000_victim_model_2=result["ASR"]["Prior-Sign-OPT-4prior"][2000],
        PriorSignOPT_4prior_5000_victim_model_2=result["ASR"]["Prior-Sign-OPT-4prior"][5000],
        PriorSignOPT_4prior_8000_victim_model_2=result["ASR"]["Prior-Sign-OPT-4prior"][8000],
        PriorSignOPT_4prior_10000_victim_model_2=result["ASR"]["Prior-Sign-OPT-4prior"][10000],

        PriorSignOPT_5prior_1000_victim_model_2=result["ASR"]["Prior-Sign-OPT-5prior"][1000],
        PriorSignOPT_5prior_2000_victim_model_2=result["ASR"]["Prior-Sign-OPT-5prior"][2000],
        PriorSignOPT_5prior_5000_victim_model_2=result["ASR"]["Prior-Sign-OPT-5prior"][5000],
        PriorSignOPT_5prior_8000_victim_model_2=result["ASR"]["Prior-Sign-OPT-5prior"][8000],
        PriorSignOPT_5prior_10000_victim_model_2=result["ASR"]["Prior-Sign-OPT-5prior"][10000],

        PriorOPT_prior1_1000_victim_model_2=result["ASR"]["Prior-OPT-1prior"][1000],
        PriorOPT_prior1_2000_victim_model_2=result["ASR"]["Prior-OPT-1prior"][2000],
        PriorOPT_prior1_5000_victim_model_2=result["ASR"]["Prior-OPT-1prior"][5000],
        PriorOPT_prior1_8000_victim_model_2=result["ASR"]["Prior-OPT-1prior"][8000],
        PriorOPT_prior1_10000_victim_model_2=result["ASR"]["Prior-OPT-1prior"][10000],

        PriorOPT_2priors_1000_victim_model_2=result["ASR"]["Prior-OPT-2prior"][1000],
        PriorOPT_2priors_2000_victim_model_2=result["ASR"]["Prior-OPT-2prior"][2000],
        PriorOPT_2priors_5000_victim_model_2=result["ASR"]["Prior-OPT-2prior"][5000],
        PriorOPT_2priors_8000_victim_model_2=result["ASR"]["Prior-OPT-2prior"][8000],
        PriorOPT_2priors_10000_victim_model_2=result["ASR"]["Prior-OPT-2prior"][10000],

        PriorOPT_3prior_1000_victim_model_2=result["ASR"]["Prior-OPT-3prior"][1000],
        PriorOPT_3prior_2000_victim_model_2=result["ASR"]["Prior-OPT-3prior"][2000],
        PriorOPT_3prior_5000_victim_model_2=result["ASR"]["Prior-OPT-3prior"][5000],
        PriorOPT_3prior_8000_victim_model_2=result["ASR"]["Prior-OPT-3prior"][8000],
        PriorOPT_3prior_10000_victim_model_2=result["ASR"]["Prior-OPT-3prior"][10000],

        PriorOPT_4prior_1000_victim_model_2=result["ASR"]["Prior-OPT-4prior"][1000],
        PriorOPT_4prior_2000_victim_model_2=result["ASR"]["Prior-OPT-4prior"][2000],
        PriorOPT_4prior_5000_victim_model_2=result["ASR"]["Prior-OPT-4prior"][5000],
        PriorOPT_4prior_8000_victim_model_2=result["ASR"]["Prior-OPT-4prior"][8000],
        PriorOPT_4prior_10000_victim_model_2=result["ASR"]["Prior-OPT-4prior"][10000],

        PriorOPT_5prior_1000_victim_model_2=result["ASR"]["Prior-OPT-5prior"][1000],
        PriorOPT_5prior_2000_victim_model_2=result["ASR"]["Prior-OPT-5prior"][2000],
        PriorOPT_5prior_5000_victim_model_2=result["ASR"]["Prior-OPT-5prior"][5000],
        PriorOPT_5prior_8000_victim_model_2=result["ASR"]["Prior-OPT-5prior"][8000],
        PriorOPT_5prior_10000_victim_model_2=result["ASR"]["Prior-OPT-5prior"][10000],
    )
    )
...
if __name__ == "__main__":
    ...
    result_distortion, result_ASR = fetch_json_content_for_multiple_priors(dataset, norm, False, arch, query_budgets, success_distortion_threshold,"mean_distortion")
    result = {"ASR":result_ASR, "distortion":result_distortion}
    draw_tables_for_multi_priors(result, "ResNet50","ConViT","CrossViT","MaxViT","ViT")