...
def draw_query_success_rate_figure(dataset, norm, targeted, arch, success_distortion_threshold, dump_file_path, xlabel, ylabel):
    ...
    plt.legend(loc='upper left', prop={'size': 18}, handlelength=3, handletextpad=0.5, borderpad=0.2,
...
if __name__ == "__main__":
    ...
    for dataset in ["ImageNet","CIFAR-10"]:
        ...
        if "CIFAR" in dataset:
            ...
            archs= ["resnet50(AT_linf_4_div_255)", "resnet50(AT_linf_8_div_255)","resnet50(AT_l2_3)"]
        targeted_list = [False]
