...
if __name__ == '__main__':
    ...
    plt.savefig("D:\\黑盒攻击论文\\hard-label attacks\\Prior-OPT\\ICLR 2025\\figures\\ablation_study\\E_gamma_square\\prior_num_vs_gamma_q={}_d={}.pdf".format(q,d), dpi=200)
    plt.close()
