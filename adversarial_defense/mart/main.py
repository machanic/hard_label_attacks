...
import math
from adversarial_defense.mart.mart import mart_loss
...
# python adversarial_defense/mart/main.py --gpu 0 --dataset CIFAR-10 --arch resnet-18 --epochs 120 --weight-decay 3.5e-3 --lr 0.01 --beta 5.0
# python adversarial_defense/mart/main.py --gpu 0 --dataset CIFAR-10 --arch WRN-34-10 --epochs 90 --weight-decay 7e-4 --lr 0.1 --beta 6.0
...
def main():
    ...
    model_path = '{}/train_pytorch_model/adversarial_train/mart/{}@{}@epoch_{}@batch_{}.pth.tar'.format(
